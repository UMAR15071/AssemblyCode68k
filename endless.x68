...
ENMY2_W_INIT EQU         16          ; Enemy initial Width
...
TIME_LOOP:
    ...
    CMP.L   #0, D3    ; IS ELAPSED TIME GREATER THAN 100 MS
    BLE     TIME_LOOP   ; WE NEED TO DELAY A BIT LONGER
...
*-----------------------------------------------------------
MOVE_ENEMY:
    SUB.L   #3,        ENEMY_X     ; Move enemy by X Value
    RTS
